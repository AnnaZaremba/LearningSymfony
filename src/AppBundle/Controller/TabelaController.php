...
{
    /**
     * @Route("/twigus/tabela", name="tabela")
     * @param Request $request
     * @Template()
     * @return array
     */
    public function tabelaAction(Request $request)
    {
        $osoba = new Osoba();
    ...
    public function deleteAction(Request $request)
    {
        ...
        return $this->redirectToRoute("tabela");
    }

    /**
     * @Route("/tabela/edytuj", name="edytuj")
     */
    public function editAction(Request $request)
    {
        ...
        return $this->render('@App/Tabela/tabela.html.twig', array(
            'form' => $form->createView(),
            'isValid' => $form->isValid(),
            'osoba' => $osoba,
            'dane' => $dane
